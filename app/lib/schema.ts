...
export function createPodcastEpisodeSchema(
  ...
  // No AI-disclosure property here on purpose: schema.org has no such term,
  // and the `disclaimer` field this used to emit was an UNKNOWN_FIELD that
  // every consumer ignored while flagging every transcribed episode page in
  // structured-data validators. The disclosure that actually reaches readers
  // and text-based crawlers is the visible <AIDisclosure> block, rendered
  // above each AI-generated section in episodes/[slug].js.
